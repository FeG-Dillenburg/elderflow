...
import { isProviderTestReturn } from './auth/provider-test-return';
...
if (context.user) await protectedText.offerUnlock(context.user, !isProviderTestReturn(window.location));
