...
export const api = {
  ...
  addMeetingTopic: (meetingId: string, input: { topicId: string; sectionId: string }) => request<MeetingTopic>(`/api/meetings/${meetingId}/topics`, { method: 'POST', body: JSON.stringify(input) }),
