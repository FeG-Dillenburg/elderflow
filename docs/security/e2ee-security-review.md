...
Each local collaborative edit is normally encrypted immediately. During a server-coordinated compaction barrier, already-created envelopes drain while new Yjs deltas remain plaintext only in the unlocked session; after the exact snapshot commits or the barrier aborts, clients resynchronize and encrypt those queued deltas against the authoritative parent. Old-parent recovery rotates to a freshly registered client epoch before resealing. Only encrypted pending envelopes remain in volatile memory during an ordinary transient disconnect. On reconnect, valid updates merge. Meeting completion atomically closes the write boundary at the committed server sequence; late divergence is rejected, discarded visibly, destroyed locally, and replaced by the canonical frozen document.
...
The ten production files below are the recommended starting points for a security review. They contain the core cryptography, volatile key handling, encrypted-document lifecycle, server key operations, and opaque collaboration boundaries. Imports and callers lead from these files to the supporting code. Each entry has a repository-relative link and an immutable link at the reviewed revision.

| Responsibility and invariant | Repository source | Reviewed source |
| --- | --- | --- |
| Browser key hierarchy, Argon2id, wrappers, recovery, and rotation candidates (INV-3, INV-4) | [crypto.ts](../../frontend/src/e2ee/crypto.ts) | [fixed](https://github.com/FeG-Dillenburg/elderflow/blob/62f719fc321e4da87aefac5bd69487311747a66e/frontend/src/e2ee/crypto.ts) |
| Unlock orchestration and volatile key distribution/cleanup (INV-2, INV-3) | [protected-text.ts](../../frontend/src/e2ee/protected-text.ts) | [fixed](https://github.com/FeG-Dillenburg/elderflow/blob/62f719fc321e4da87aefac5bd69487311747a66e/frontend/src/e2ee/protected-text.ts) |
| Scalar padding, authenticated encryption, signatures, and context binding (INV-1, INV-4, INV-5) | [scalar-codec.ts](../../frontend/src/e2ee/scalar-codec.ts) | [fixed](https://github.com/FeG-Dillenburg/elderflow/blob/62f719fc321e4da87aefac5bd69487311747a66e/frontend/src/e2ee/scalar-codec.ts) |
| Volatile scalar keys, monotonic counters, and historical read keys (INV-3, INV-5) | [scalar-session.ts](../../frontend/src/e2ee/scalar-session.ts) | [fixed](https://github.com/FeG-Dillenburg/elderflow/blob/62f719fc321e4da87aefac5bd69487311747a66e/frontend/src/e2ee/scalar-session.ts) |
| Encrypted Yjs update/snapshot formats and stable semantic fragments (INV-1, INV-4, INV-5) | [meeting-document-codec.ts](../../frontend/src/e2ee/meeting-document-codec.ts) | [fixed](https://github.com/FeG-Dillenburg/elderflow/blob/62f719fc321e4da87aefac5bd69487311747a66e/frontend/src/e2ee/meeting-document-codec.ts) |
| Volatile Meeting-document lifecycle, remote updates, copy-forward, and compaction (INV-3, INV-6) | [meeting-document-session.ts](../../frontend/src/e2ee/meeting-document-session.ts) | [fixed](https://github.com/FeG-Dillenburg/elderflow/blob/62f719fc321e4da87aefac5bd69487311747a66e/frontend/src/e2ee/meeting-document-session.ts) |
| Browser WebSocket synchronization, encrypted pending queue, reconnect, and canonical discard (INV-1, INV-4, INV-6) | [meeting-collaboration.ts](../../frontend/src/e2ee/meeting-collaboration.ts) | [fixed](https://github.com/FeG-Dillenburg/elderflow/blob/62f719fc321e4da87aefac5bd69487311747a66e/frontend/src/e2ee/meeting-collaboration.ts) |
| Server key state, client epochs, two-operator ceremonies, activation, and revocation (INV-2, INV-3, INV-5) | [e2ee.service.ts](../../backend/src/e2ee/e2ee.service.ts) | [fixed](https://github.com/FeG-Dillenburg/elderflow/blob/62f719fc321e4da87aefac5bd69487311747a66e/backend/src/e2ee/e2ee.service.ts) |
| Opaque Meeting-document validation, sequencing, persistence, compaction, and completion freeze (INV-1, INV-4, INV-6) | [meeting-document.service.ts](../../backend/src/meetings/meeting-document.service.ts) | [fixed](https://github.com/FeG-Dillenburg/elderflow/blob/62f719fc321e4da87aefac5bd69487311747a66e/backend/src/meetings/meeting-document.service.ts) |
| Authorized blind WebSocket relay, signature/epoch checks, awareness, and completion close (INV-1, INV-2, INV-4, INV-6) | [meeting-collaboration-relay.service.ts](../../backend/src/meetings/meeting-collaboration-relay.service.ts) | [fixed](https://github.com/FeG-Dillenburg/elderflow/blob/62f719fc321e4da87aefac5bd69487311747a66e/backend/src/meetings/meeting-collaboration-relay.service.ts) |
